...
from coOccure import load_dataset
from tSNE import project_words
...
def self_SVD(matrix, n_iter = 10):
    ...
    s,u,v = svd.svd(matrix)
    return u

if __name__ == "__main__":
    svd_worker = 'lib' # Default
    ...
    project_words(projections, term2id)
...
# ax1.scatter(cluster_projections[topic_list[counter],:,0], cluster_projections[topic_list[counter],0:5,1])
